// ------------------------------------------------------------
// ITM example for Cortex-M4 on ST STM32MP15x
//
...
int main(int argc, char** argv)
{
    ...
    char outputStr[64];
    /* IMPORTANT */
    /* To capture ITM data with the Debugger, select Run->Debug Configurations, then select the ITM_Cortex-M4_STM32MP15x debug config.
