/*
 * GICv3_gicc.h - prototypes and inline functions for GICC system register operations, with minor changes for AArch32
 *
...
{
    sgirIRMTarget = 0,
    sgirIRMAll = (1ul << (40-32)) /* changed for AArch32 */
} ICC_SGIRBits_t;
