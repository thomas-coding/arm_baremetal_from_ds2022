...
/* This code contains a deliberate bug for you to locate using the Debugger */


#include <stdio.h>

// The Debugger enables semihosting automatically if either symbols
//  "__auto_semihosting" or "__semihosting_library_function" are present in an image.
// Arm Compiler for Embedded 6 adds "__semihosting_library_function" automatically to an image
